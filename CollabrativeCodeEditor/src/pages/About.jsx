...
const developers = [
  {
    ...
    age: 20,
    gender: "Male",
    imageUrl: "https://placehold.co/100x100/7dd3fc/0f172a?text=AJ&font=roboto",
  ...
  },
  {
    ...
    age: 20,
    gender: "Male",
    imageUrl: "https://placehold.co/100x100/a78bfa/0f172a?text=SL&font=roboto",
    github: "https://github.com/samanthalee",
    instagram: "https://instagram.com/samanthalee",
    email: "mailto:samantha.lee@example.com",
  },
  {
    name: "Devkaran Singh",
    ...
    age: 20,
    gender: "Male",
    imageUrl: "https://placehold.co/100x100/6ee7b7/0f172a?text=MC&font=roboto",
    github: "https://github.com/mikechen",
    instagram: "https://instagram.com/mikechen",
    email: "mailto:mike.chen@example.com",
  },
  {
    ...
    age: 20,
    gender: "Male",
    imageUrl: "https://placehold.co/100x100/f87171/0f172a?text=PS&font=roboto",
        ...
        <div className="space-y-16">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 leading-relaxed"> Solo learners and students focused on self-improvement.</p>
...
//       {/* --- Mission Statement --- */}
//       <p className="max-w-3xl text-center text-lg text-gray-300 leading-relaxed mb-6">
//         {" "}
//         {/* 1. Adjusted margin from mb-20 to mb-6 */}
//         We are building the single, frictionless environment where developers
//         can truly build as one. No more juggling tools—just pure, intelligent
//         collaboration.
//       </p>

//       {/* --- 2. MOVED "Closing" div here, restyled as summary --- */}
//       <div className="max-w-3xl text-center mb-20">
//         {" "}
//         {/* 3. Changed mt-24 to mb-20 */}
...
//                   {dev.name}
//                 </h3>
//                 < className="text-sm text-teal-400 font-mono tracking-wide">
//                   {dev.stack}
//                 </>
//                 <div className="flex text-gray-400 text-sm mt-2 space-x-4">
//                   <span>Age: {dev.age}</span>
...
//       {/* --- 4. REMOVED Closing div from here --- */}
//     </div>
//   );
// };
