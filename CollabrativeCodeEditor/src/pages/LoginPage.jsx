...
//   Link,
//   useNavigate,
//   useLocation, // 2. Import useLocation
//   Navigate, // 3. Import Navigate
...
// const LoginPage = () => {
//   // 4. Get 'user' from auth, not just 'setUser'
...
//   const location = useLocation(); // 5. Get the current location

//   // 6. ADDED: This effect checks for redirects and shows the toast
//   useEffect(() => {
...
//     }
//   }, [location]); // Run this check when the component loads

//   // 7. ADDED: Redirect if user is already logged in
//   if (user) {
...
//         // 8. MODIFIED: Navigate back to the page they wanted
//         const from = location.state?.from?.pathname || "/";
...
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4 pb-10">
...
//             Welcome back
//           </h2>
//           <p className="mt-2 text-gray-400">Sign in to your FixMate account</p>
//         </div>
