...
//     },
//     // 2. Added the new feature object
//     {
...
//             {/* --- CONDITIONAL ACTION LAYOUT --- */}
//             {!loading && !user ? (
//               // --- GRID LAYOUT (Logged Out) ---
//               <div className="max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 mb-16">
//                 {/* 1. Name Input */}
//                 <input
//                   type="text"
...
//               // This layout appears if user is loaded AND logged in
...
//           {/* 3. Changed grid to md:grid-cols-2 to create a 2x2 layout */}
...
//                       ? "text-purple-400"
//                       : "text-teal-400"
//                   }`} // Use a different color for the new feature
//                 >
//                   {feature.icon}
//                 </div>
//                 <h3
...
//             Join thousands of developers already collaborating on FixMate
//           </p>
//           <button
...
//               speed. Go from Beginner to Advance Level in one space with integrated
...
//             <img
//               src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExamFib3lqb2dudW9oZ2h1NnpkaDRwZWpuMXo2YTA0Y2V2NmxmdmtrZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/jdPMeyv9rn0hZHh8n9/giphy.gif"
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden md:block">
            <img
              // src="https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3azBkdG1wbGdlbDJpdmZoMXFsczEyYzJycGl0YWQzaXVkMzVteGU2OCZlcD12MV9zdGlja2Vyc19yZWxhdGVkJmN0PXM/aIJDrOomj81MQZz2uO/giphy.gif"
