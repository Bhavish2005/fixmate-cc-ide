...
// import { Code2, Menu, X, User, Code, Code2Icon } from "lucide-react";
...
//   if (user) {
//     // Add links only visible when logged in
//     navLinks.push({ name: "Dashboard", path: "/dashboard" });
//   }

//   const isActive = (path) => location.pathname === path;

//   // --- Re-added Scroll listener ---
//   useEffect(() => {
//     const handleScroll = () => {
...
//       setUser(null);
//       // --- 3. ADDED SUCCESS TOAST ON LOGOUT ---
...
//               <form className="m-5" onSubmit={handleLogout}>
//                 <button
//                   type="submit"
...
const Navbar = () => {
  ...
  // --- Dynamic Nav Links (Dashboard REMOVED) ---
  const navLinks = [
    { name: "Home", path: "/" },
    { name: "About", path: "/about" },
  ];

  // --- Dashboard link is no longer added here ---
  // if (user) {
  //   navLinks.push({ name: "Dashboard", path: "/dashboard" });
  // }
