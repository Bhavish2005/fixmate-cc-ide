...
//   try {
//     const response = await fetch("http://localhost:4000/auth/get-run-logs", {
//       method: "GET",
//       credentials: "include",
//     });
...
//       };
//     }
//     // 2. Master Coder (High activity, high success)
...
//       };
//     }
//     // 3. Consistent Coder (Good activity, good success)
...
//       };
//     }
//     // 4. Rising Learner (Shows improvement)
...
//   if (isLoading) {
//     return (
//       <div className="min-h-screen bg-[#0b1221] text-white p-6 flex items-center justify-center">
...
//       {/* --- MODIFIED: Header with Status Badge --- */}
...
//         <StatCard
//           title="Total Errors"
//           value={errorsOnly.length}
//           icon={<AlertTriangle />}
//           color="text-red-400"
//         />
//         <StatCard
//           title="Last Activity"
//           value={logs[0] ? new Date(logs[0].createdAt).toLocaleString() : "—"}
//           icon={<Clock />}
//           color="text-gray-400"
//         />
//       </div>
...
//                 <Tooltip
//                   contentStyle={{
//                     backgroundColor: "#F5F5F5", // A light gray, not pure white
//     border: "1px solid #DDD",    // A softer border to match
//     borderRadius: "8px",         // This makes it rounded
//   }}
//   labelStyle={{ color: "#333", fontWeight: "bold" }} // Dark text for the title
//   itemStyle={{ color: "#555" }}
//                 />
//                 <Legend />
//               </PieChart>
...
//                     <Cell
//                       key={`cell-${index}`}
//                       fill={CATEGORY_COLORS[entry.name] || PIE_COLORS[index]}
//                     />
//                   ))}
//                 </Pie>
//                 <Tooltip
...
//               style={{ borderColor: CATEGORY_COLORS[p.category] || "#fff" }}
//             >
//               <div className="text-sm font-semibold text-white">
//                 {p.category} Error
//               </div>
//               <div className="text-lg text-gray-200 truncate">{p.error}</div>
//               <div className="text-xs text-gray-400">
//                 You've made this mistake {p.count} times.
//               </div>
//             </div>
//           ))}
//         </div>
...
//                     {e.isSuccess ? "Successful Run" : e.error}
//                   </p>
//                 </div>
...
// function StatCard({ title, value, icon, color = "text-[#00c2ff]" }) {
//   return (
//     <div className="bg-[#1b2233] p-5 rounded-xl shadow-md hover:bg-[#222a3d] transition">
//       <div className="flex items-center justify-between">
//         <div>
//           <p className="text-sm text-gray-400">{title}</p>
//           <h2 className="text-3xl font-bold mt-2">{value}</h2>
//         </div>
//         <div className={color}>{React.cloneElement(icon, { size: 28 })}</div>
//       </div>
//     </div>
//   );
// }
...
// import { useAuth } from "../context/AuthContext.jsx";
// import {
//   Clock, // Note: This is no longer used, but left in case
//   AlertTriangle,
//   Code,
//   Activity,
//   LineChart as LineChartIcon,
...
//         return { category, error, count };
//       })
//       .filter((d) => d.error) // Filter out items with no error
...
//     };
//   }, [logs.length, successfulRuns.length, learningCurveData]);
//   // --- NEW: ECharts Pie Chart Options ---
//   const pieChartOptions = useMemo(() => {
//     // ECharts needs a specific color mapping for its data
//     const dataWithColors = errorsByCategory.map(entry => ({
//       name: entry.name,
//       value: entry.count, // ECharts uses 'value'
//       itemStyle: {
//         color: CATEGORY_COLORS[entry.name] || '#6b7280' // Default color
//       }
//     }));

//     return {
//       backgroundColor: 'transparent', // Use the card's background
//       tooltip: {
//         trigger: 'item',
//         formatter: '{b}: {c} ({d}%)', // {b}=name, {c}=value, {d}=percent
//         backgroundColor: '#1b2233', // Dark background for tooltip
//         borderColor: '#333',
//         borderWidth: 1,
//         textStyle: {
...
//           type: 'pie',
//           radius: ['40%', '70%'], // This makes it a donut chart
...
//       {/* --- NEW Performance & Learning Curve Grid --- */}
...
//           {learningCurveData.length > 1 ? (
//             <div className="h-[400px] lg:h-full py-4"> {/* Adjusted height */}
//               <ResponsiveContainer>
//                 <LineChart
//                   data={learningCurveData}
//                   margin={{ top: 5, right: 20, left: -20, bottom: 5 }}
...
//           labelStyle={{ color: "#333", fontWeight: "bold" }}
//           itemStyle={{ color: "#555" }}
//           cursor={{ fill: "rgba(100, 100, 100, 0.2)" }} // Hover effect
//         />
//         <Bar dataKey="count">
//           {/* This maps colors to each bar just like your pie chart */}
//           {errorsByLanguage.map((entry, index) => (
//             <Cell
//               key={`cell-${index}`}
//               fill={PIE_COLORS[index % PIE_COLORS.length]}
...
// // 🚨 StatCard function is no longer needed and has been removed.
...
async function getRunLogs() {
  try {
    // ✅ FIX: Added Cache-Control headers to force fresh data
    const response = await fetch("http://localhost:4000/auth/get-run-logs", {
      method: "GET",
      credentials: "include",
      headers: {
